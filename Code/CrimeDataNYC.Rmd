...
<span style="color:darkblue"><b>Borough Analysis</b></span>
...
*Please visit our <a href="https://bl.ocks.org/CrimeDataNyc/raw/e3362fde2a5f94aa2fa94a524742a566/441a18c0a089ca75e03009376006eff10dd38eb8/" target="_blank">
D3 Mosaic Plots</a> and review the three choices there. You should move your mouse over each block to reveal both Level and Borough.*
...
```{r fig.height=5, fig.width=14}
  ...
  mosaic(OffenseDesc~Boro, main ="Top Offense Distribution across Boroughs", direction=c("v"), labeling=labeling_border(rot_labels=c(15,0,0, 0), offset_labels = c(0,0,0,6.5), offset_varnames = c(1,0,0,11.6), just_labels=c("left", "left", "left", "center")), crime_sort)
...
<span style="color:darkblue"> <b>The Full Moon </b></span>
...
kable(sumtab,"html",caption="Crime by Borough, Level of Crime proportions") %>%
    kable_styling( full_width = F) %>%
    group_rows("Violent Crimes and Drugs ", 4,5) %>%
    footnote( general = " ",
              number = c("Above Table is auto-generated from the Crime Dataset directly",
                         "Violent Crimes and Dangerous Drugs are subcategories of the Felony, Misdemeanor and Violation categories shown",
                         "Felony, Misdemeanor and Violation figures of each Borough add up to 100%")
           )
```
...
And with that, we submit this project.
- Anita, Brent, Jingbo, Rashmi and Rich
