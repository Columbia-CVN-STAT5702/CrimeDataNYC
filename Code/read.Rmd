...
#factor variables that you want them to be factor type, modify the variable list to your needs 
crime_df[,c("KY_CD","ADDR_PCT_CD","PREM_TYP_DESC")]<-lapply(crime_df[,c("KY_CD","ADDR_PCT_CD","PREM_TYP_DESC")],factor)
