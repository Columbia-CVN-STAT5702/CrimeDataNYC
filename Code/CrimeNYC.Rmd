...
```{r fig.height=5, fig.width=16}
  ...
  mosaic(OffenseDesc~Boro, main ="Top Offense Distribution across Boroughs", direction=c("v"), labeling=labeling_border(rot_labels=c(15,0,0, 0), offset_labels = c(0,0,0,6.3), offset_varnames = c(1,0,0,11.6), just_labels=c("left", "left", "left", "center")), crime_sort)
...
The dataset includes a field **shazbot** to indicate where the crime took place, such as on the street, in a house, etc. It turns out that about 85% of crime occurs on the Streets or within a Residence of one type or another.  
...
* General Decreasing Trend over 2006 to 2016  

**Jingbo Plot - Need updated lower plot only, refer doc ** 
...
*Do we need a graph with starting point here *  

* Have Drugs and Violent crime decreased as well?  
...
*Jingbo Plots - Modify axis labels visibility *
